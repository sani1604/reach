...
return [
    ...
    */
    'api_key'      => env('SHOPIFY_API_KEY', env('SHOPIFY_REACH_API_KEY')),
    'api_secret'   => env('SHOPIFY_API_SECRET', env('SHOPIFY_REACH_API_SECRET')),

    // Latest stable Admin API version (quarterly releases, 12-month support).
    'api_version'  => env('SHOPIFY_API_VERSION', '2026-07'),

    // webPixelCreate needs write_pixels + read_customer_events together.
    'scopes'       => array_filter(array_map('trim', explode(',', env(
        'SHOPIFY_APP_SCOPES',
        'read_orders,read_products,write_pixels,read_customer_events'
    )))),

    // Scopes required specifically for Customer Events / web pixel activation.
    'pixel_scopes' => ['write_pixels', 'read_customer_events'],
