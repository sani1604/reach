...
import type { AddLineItemOptions, Address, Cart, CartUpdateInput, Customer, CustomSale, SetLineItemDiscountInput, SetLineItemPropertiesInput, SetLineItemSellingPlanInput } from '../../types/cart';
/**
...
export interface MutableCartApiContent {
     ...
     */
    addLineItem(variantId: number, quantity: number, options?: AddLineItemOptions): Promise<string>;
    /**
