...
<body class="landing">
    <div class="wrap">
        ...
        <div class="hero" style="padding-top: 64px;">
            ...
            <form method="GET" action="{{ route('auth.install') }}" style="max-width: 420px; margin: 0 auto;">
                ...
                <button class="btn btn-primary btn-lg" type="submit" style="width: 100%; justify-content: center;">Install Free</button>
            </form>
